  ...
  const handleSubmit = useCallback(
    async (e: any) => {
      ...
      try {
        ...
        const response = fetch('http://localhost:6868/api/location', requestOptions);
      ...
      <form onSubmit={handleSubmit}>
        <Box sx={{ flexGrow: 1 }}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <input id="latitude" disabled value={latitude} placeholder="latitude" />
            </Grid>
            <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              <input id="longitude" disabled value={longitude} placeholder="longitude" />
            </Grid>
            <Grid item xs={12}>
